PRO film2, ENC=enc, border=border

; postscript-file oeffnen
IF KEYWORD_SET(enc) THEN BEGIN
	psp,"film2",/times,/enc
ENDIF ELSE psp,"film2",/times
...
factor = [0.0385123,0.493604,0.907366,1]
RESTORE, "ranges.dat"
...
psshows, 1.6/textwidth, (im_offy-0.7+3*im_ysz+2*ymrgn+1.9)/textheight, '!{32}T!m!DOP!d!b!U*!u', SIZE=label_chsz, /NORMAL, /XCENTER, ROTATE=-90
psshows, 1.6/textwidth, (im_offy-0.7+2*im_ysz+1*ymrgn+1.9)/textheight, '!{32}T!m!DOD!d!b!U*!u', SIZE=label_chsz, /NORMAL, /XCENTER, ROTATE=-90
