...
lateralen Verbindungsreichweiten zwischen den Neuronen ausbildet~\cite{loewel:1988}.
Die Autoren erwogen, daß nicht nur die Wellenlänge,
...
Verbindungsreichweiten lieferten u.A. Untersuchungen am Frettchen~\cite{katz:1994}\footnote{Die Autoren dieser Arbeit diskutieren hauptsächlich
...
\begin{figure}[ht!]
    ...
    Affen \parencite[6.4mm$\times$4.3mm, optisches
    Ableiten,][]{grinvald:1991} und aus A17 einer normalsichtigen und strabismischen Katze
        \parencite[{jeweils 5mm$\times$3mm, [$^3$H]--Prolin
        Markierung,}][]{loewel:1987}. Neben jedem Bild ist die dazugehörige Autokorrelation
...
\begin{figure}[p]
    \begin{sideways}
        \epsfig{file=pics/opod_rot.eps,width=8.35cm}
    \end{sideways}
    \caption{Momentaufnahmen der koordinierten Entwicklung von Okular\-do\-mi\-nanz--
    und Ori\-en\-tie\-rungs\-karten für
        $\sigma^\ast_{\text{OP}}>\sigma^\ast_{\text{OD}}$ (Szenarium
        Abb.~\ref{zeitentwicklung}a). Die Farb-- / Grau\-wert\-intensität spiegelt
    ...
    \label{opod}
    \begin{sideways}
        \epsfig{file=pics/odop_rot.eps,width=8.35cm}
    \end{sideways}
...
\begin{figure}[t]
    ...
    Ori\-en\-tie\-rungs\-präferenz--Karten für die Katze (links, Ergebnis der in
